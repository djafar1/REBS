...
class Dcr2PetriNet(object):
    ...
    def export_debug_net(self, tapn, m, path, step, pn_export_format):
        ...
        pnml_exporter.apply(tapn, m, debug_save_path, variant=pn_export_format, parameters={'isTimed': False})
    ...
    def apply(self, G, tapn_path, **kwargs) -> (PetriNet, Marking):
        ...
        pnml_exporter.apply(tapn, m, tapn_path, variant=pn_export_format, parameters={'isTimed': False})
